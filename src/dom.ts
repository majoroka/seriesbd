...
export const accountSyncStatusLabel = document.getElementById('account-sync-status-label') as HTMLParagraphElement;
export const accountSyncStatusDetail = document.getElementById('account-sync-status-detail') as HTMLParagraphElement;
export const restoreCloudLibraryBtn = document.getElementById('restore-cloud-library-btn') as HTMLButtonElement;
export const replaceCloudLibraryBtn = document.getElementById('replace-cloud-library-btn') as HTMLButtonElement;
...
export const authEmailGroup = document.getElementById('auth-email-group') as HTMLDivElement;
export const authEmailInput = document.getElementById('auth-email') as HTMLInputElement;
export const authPasswordGroup = document.getElementById('auth-password-group') as HTMLDivElement;
export const authPasswordInput = document.getElementById('auth-password') as HTMLInputElement;
export const authPasswordConfirmGroup = document.getElementById('auth-password-confirm-group') as HTMLDivElement;
export const authPasswordConfirmInput = document.getElementById('auth-password-confirm') as HTMLInputElement;
...
export const authForgotPasswordBtn = document.getElementById('auth-forgot-password-btn') as HTMLButtonElement;
